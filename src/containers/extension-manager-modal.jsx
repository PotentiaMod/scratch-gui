...
import ExtensionManagerModalComponent from '../components/extension-manager-modal/extension-manager-modal.jsx';

class TWExtensionManagerModal extends React.Component {
    constructor (props) {
        super(props);
        bindAll(this, [
            'handleClose',
	...
	removeUnusedExtensions (extensions) {
    ...
    render () {
        return (
            <ExtensionManagerModalComponent
                ...
                removeUnusedExtensions={this.removeUnusedExtensions}
...
TWExtensionManagerModal.propTypes = {
    intl: intlShape,
